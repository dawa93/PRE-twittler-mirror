...
//message: 'Welcome to Code States #codestates',
//created_at: '2019-01-03 12:30:20'
function putNewTweet() {
  let newUser = document.querySelector(".username_box").value;
  let newComment = document.querySelector(".comment_box").value;
  let d1 = new Date();
  let currentDate = d1.format();
  let obj = {};
...
let postNewFeed = document.querySelector(".tweet_button");
postNewFeed.addEventListener("click", putNewTweet);
